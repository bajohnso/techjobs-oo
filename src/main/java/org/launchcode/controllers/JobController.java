...
public class JobController {
    ...
    public String index(Model model, @RequestParam(value="id")int id) {
    ...
    public String add(Model model, @ModelAttribute @Valid JobForm jobForm, /*@PathVariable int id,*/ Errors errors) {
